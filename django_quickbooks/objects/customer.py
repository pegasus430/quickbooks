...
class Customer(BaseObject):
    fields = dict(
        ...
        FullName=dict(required=False, validator=dict(type=SchemeValidator.STRTYPE)),
        IsActive=dict(validator=dict(type=SchemeValidator.STRTYPE)),
        ...
        LastName=dict(validator=dict(type=SchemeValidator.STRTYPE)),
        JobTitle=dict(validator=dict(type=SchemeValidator.STRTYPE)),
        MiddleName=dict(required=False, validator=dict(type=SchemeValidator.STRTYPE)),
