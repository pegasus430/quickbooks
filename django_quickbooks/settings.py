...
from quickbooks.settings import env
...
DEFAULTS = {
    ...
    'REDIS_DEFAULT_HOST': env('REDIS_HOST'),
    'REDIS_DEFAULT_PORT': env('REDIS_PORT'),
    'REDIS_DEFAULT_DB': 0,
    'REDIS_DEFAULT_PASSWORD': None,
    
    'APP_URL': f'{settings.APP_URL}quickbooks-desktop/',
    'APP_SUPPORT': f'{settings.APP_URL}quickbooks-desktop/support/',
    'APP_ID': '',
    'APP_NAME': 'Some App',
